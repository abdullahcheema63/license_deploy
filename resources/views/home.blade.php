    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li><a href="{{route('inspector.index')}}"><i class="fa fa-user"></i><span class="nav-label">Inspector</span></a></li>
                @endcan
                <li>
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li>
                        <form action="{{url('logout')}}" method="post">
                            {{csrf_field()}}
                            <a><i class="fa fa-sign-out "></i><input type="submit" style="background: none; border: none" value="Log Out"></a>
                        </form>
                    </li>
                    <li>
        ...
        <div class="row  border-bottom white-bg dashboard-header">
            <div class="carousel slide" id="carousel2">
                <ol class="carousel-indicators">
                    ...
                    <li data-slide-to="4" data-target="#carousel2" class=""></li>
                    <li data-slide-to="5" data-target="#carousel2" class=""></li>
                </ol>
                <div class="carousel-inner">
                    <div class="item active">
                        <img alt="image" class="img-responsive" style="width: 100% !important;" src="{{asset("images/homepage banner-01.jpg")}}">
                        <div class="carousel-caption">
                            <p>This is simple caption 1</p>
                        </div>
                    </div>
                    <div class="item ">
                        <img alt="image" class="img-responsive" style="width: 100% !important;" src="{{asset("images/homepage banner-02.jpg")}}">
                        <div class="carousel-caption">
                            <p>This is simple caption 2</p>
                        </div>
                    </div>
                    <div class="item">
                        <img alt="image" class="img-responsive" style="width: 100% !important;" src="{{asset("images/homepage banner-03.jpg")}}">
                        <div class="carousel-caption">
                            <p>This is simple caption 3</p>
                        </div>
                    </div>
                    <div class="item">
                        <img alt="image" class="img-responsive" style="width: 100% !important;"  src="{{asset("images/homepage banner-04.jpg")}}">
                        <div class="carousel-caption">
                            <p>This is simple caption 3</p>
                        </div>
                    </div>
                    <div class="item">
                        <img alt="image" class="img-responsive"  style="width: 100% !important;" src="{{asset("images/homepage banner-05.jpg")}}">
                        <div class="carousel-caption">
                            <p>This is simple caption 3</p>
                        </div>
                    </div>
                    <div class="item">
                        <img alt="image" class="img-responsive" style="width: 100% !important;" src="{{asset("images/homepage banner-06.jpg")}}">
                        <div class="carousel-caption">
                            <p>This is simple caption 3</p>
                        </div>
                    </div>
